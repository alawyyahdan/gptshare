    ...
    <t-card class="list-card-container">
      ...
      >
        <template #gpt_account_name_list="{ row }">
          <t-popup trigger="hover" :show-arrow="true" placement="right">
            ...
            <t-link variant="outline"> ChatGPT Account {{ row.gpt_account_name_list.length }} individual </t-link>
          </t-popup>
      ...
      <t-dialog v-model:visible="showDialog" :on-confirm="handleConfirm" title="Add User" width="800px">
        ...
        >
          ...
          <t-form-item label="Pilih ChatGPT" name="gptcar_list">
...
const columns: TableProps['columns'] = [
  { colKey: 'car_name', title: 'Nama', width: 220 },
  { colKey: 'gpt_account_name_list', title: 'Akun GPT', width: 200 },
