...
const columnsChatgptDetails: TableProps['columns'] = [
  ...
  { colKey: 'plan_type', title: 'Type', width: 30 },
  { colKey: 'auth_status', title: 'State', width: 30 },
  { colKey: 'mirror_token', title: 'Mirror Token (used for API, this token will not change)', width: 100 },
