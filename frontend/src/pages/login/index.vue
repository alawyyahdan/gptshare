  ...
  <div style="display: flex; flex-direction: column">
    <div style="display: flex; justify-content: space-between">
      ...
      <div v-if="cfg.show_github" style="margin: 12px 20px">
        <a :href="Creditz" target="_blank" style="float: right">
          <svg
            width="32"
            height="32"
            t="1718179802093"
    ...
    <div class="login-container">
      <t-card class="login-card">
        <h2 class="login-title">
          ...
          <div v-if="IsRegister">Buat akun</div>
          ...
          <t-form :data="loginForm" :label-width="0" :rules="rules" ref="loginFormRef" @submit="onSubmit">
            ...
            <t-form-item v-if="loginType === 'register'" name="chatgpt_token">
              <div style="display: flex; flex-direction: column; width: 100%">
                ...
                <span style="font-size: 12px; color: #888">
                  Session Token (Lihat Tutorial) ：
                  <t-link target="_blank" theme="primary" size="small" :href="ChatgptTokenTutorialUrl">Dapatkan secara manual</t-link>
                  <!-- or
            ...
            <t-form-item>
              <t-button theme="success" type="submit" size="large" class="login-button">
                <span v-if="IsRegister">Daftar</span>
...
const rules: Record<string, FormRule[]> = {
  username: [{ required: true, message: 'Silakan masukkan username', trigger: 'blur' }],
  password: [{ required: true, message: 'Silakan masukkan kata sandi', trigger: 'blur' }],
  chatgpt_token: [
    { required: true, message: 'Silakan masukkan Access Token atau Session Token atau Refresh Token', trigger: 'blur' },
  ],
};
