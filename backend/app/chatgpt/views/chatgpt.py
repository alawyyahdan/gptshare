...
class ChatGPTAccountView(generics.ListCreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"message": "Successful entry"})
    ...
    def put(self, request):
        ...
        return Response({"message": "Update GPT information successfully"})
...
class ChatGPTLoginView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.data["chatgpt_id"] not in user_gpt_id_list:
            raise ValidationError("The account does not belong to the current user")
