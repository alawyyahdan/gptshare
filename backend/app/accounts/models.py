...
class User(AbstractUser):
    ...
    isolated_session = models.BooleanField(default=True, verbose_name="Independent Response")
    gptcar_list = models.JSONField(default=list)
    expired_date = models.DateField(blank=True, null=True, verbose_name="Expiration Date")
